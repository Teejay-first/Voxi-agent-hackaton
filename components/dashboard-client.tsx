        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="lg:col-span-1 space-y-3 sm:space-y-4">
            <h2 className="text-base sm:text-lg font-semibold text-neutral-900 mb-3 sm:mb-4 font-poppins tracking-tight">
              Your Agents ({initialAgents.length})
            </h2>
            {initialAgents.length === 0 ? (
              <Card className="p-4 bg-neutral-50 border-neutral-200 rounded-[28px]">
                <p className="text-sm text-neutral-600 font-poppins">No agents found. Create one to get started!</p>
              </Card>
            ) : (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-1">
                      {/* Placeholder for deployment icons */}
                    </div>
                  </div>
                </Card>
              ))
                ...
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-neutral-600 font-poppins tracking-tight">
                      {selectedAgent?.tagline || selectedAgent?.category || "Select an agent from the list"}
                    </p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <Card className="bg-neutral-50 border-neutral-200 rounded-xl p-4">
                      <p className="text-sm sm:text-base text-neutral-700 font-poppins tracking-tight">
                        {selectedAgent?.short_desc || "No description available for this agent."}
                      </p>
                    </Card>
                  </div>
